...
`;var Z=class extends I{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=!!this.href,e=t?Rt`a`:Rt`button`;return Et`
    ...
    `}};Z.styles=Ni;Z.dependencies={"sl-icon":G};a([N(".icon-button")],Z.prototype,"button",2);a([et()],Z.prototype,"hasFocus",2);a([n()],Z.prototype,"name",2);a([n()],Z.prototype,"library",2);a([n()],Z.prototype,"src",2);a([n()],Z.prototype,"href",2);a([n()],Z.prototype,"target",2);a([n()],Z.prototype,"download",2);a([n()],Z.prototype,"label",2);a([n({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);var Ai=new Map,_s=new WeakMap;function Ks(t){return t??{keyframes:[],options:{duration:0}}}function Wi(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function q(t,e){Ai.set(t,Ks(e))}function P(t,e,o){let i=_s.get(t);if(i?.[e])return Wi(i[e],o.dir);let s=Ai.get(e);return s?Wi(s,o.dir):{keyframes:[],options:{duration:0}}}function mt(t,e){return new Promise(o=>{function i(s){s.target===t&&(t.removeEventListener(e,i),o())}t.addEventListener(e,i)})}function tt(t,e,o){return new Promise(i=>{if(o?.duration===1/0)throw new Error("Promise-based animations must be finite.");let s=t.animate(e,yt(H({},o),{duration:$s()?0:o.duration}));s.addEventListener("cancel",i,{once:!0}),s.addEventListener("finish",i,{once:!0})})}function $s(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ot(t){return Promise.all(t.getAnimations().map(e=>new Promise(o=>{let i=requestAnimationFrame(o);e.addEventListener("cancel",()=>i,{once:!0}),e.addEventListener("finish",()=>i,{once:!0}),e.cancel()})))}var Di=C`
  ${L}
...
`;var Vt=class extends I{constructor(){super(...arguments),this.hasSlotController=new E(this,"prefix","suffix"),this.rel="noreferrer noopener"}render(){let t=!!this.href;return m`
      <div
        part="base"
...
`;var Uo=class extends I{constructor(){super(...arguments),this.hasSlotController=new E(this,"footer","header","image")}render(){return m`
      <div
        part="base"
...
`;var j=class extends I{constructor(){super(...arguments),this.type="normal",this.checked=!1,this.value="",this.disabled=!1,this.localize=new k(this),this.hasSlotController=new E(this,"submenu"),this.submenuController=new ms(this,this.hasSlotController,this.localize),this.handleHostClick=t=>{this.disabled&&(t.preventDefault(),t.stopImmediatePropagation())},this.handleMouseOver=t=>{this.focus(),t.stopPropagation()}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleHostClick),this.addEventListener("mouseover",this.handleMouseOver)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleHostClick),this.removeEventListener("mouseover",this.handleMouseOver)}handleDefaultSlotChange(){let t=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=t;return}t!==this.cachedTextLabel&&(this.cachedTextLabel=t,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return bi(this.defaultSlot)}isSubmenu(){return this.hasSlotController.test("submenu")}render(){let t=this.localize.dir()==="rtl",e=this.submenuController.isExpanded();return m`
    ...
    `}};j.styles=Bs;j.dependencies={"sl-icon":G,"sl-popup":w};a([N("slot:not([name])")],j.prototype,"defaultSlot",2);a([N(".menu-item")],j.prototype,"menuItem",2);a([n()],j.prototype,"type",2);a([n({type:Boolean,reflect:!0})],j.prototype,"checked",2);a([n()],j.prototype,"value",2);a([n({type:Boolean,reflect:!0})],j.prototype,"disabled",2);a([O("checked")],j.prototype,"handleCheckedChange",1);a([O("disabled")],j.prototype,"handleDisabledChange",1);a([O("type")],j.prototype,"handleTypeChange",1);var Pe=class extends I{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(t){if(!(t.target instanceof j))return;let e=t.target;e.type==="checkbox"&&(e.checked=!e.checked),this.emit("sl-select",{detail:{item:e}})}handleKeyDown(t){if(t.key==="Enter"||t.key===" "){let e=this.getCurrentItem();t.preventDefault(),t.stopPropagation(),e?.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(t.key)){let e=this.getAllItems(),o=this.getCurrentItem(),i=o?e.indexOf(o):0;e.length>0&&(t.preventDefault(),t.stopPropagation(),t.key==="ArrowDown"?i++:t.key==="ArrowUp"?i--:t.key==="Home"?i=0:t.key==="End"&&(i=e.length-1),i<0&&(i=e.length-1),i>e.length-1&&(i=0),this.setCurrentItem(e[i]),e[i].focus())}}handleMouseDown(t){let e=t.target;this.isMenuItem(e)&&this.setCurrentItem(e)}handleSlotChange(){let t=this.getAllItems();t.length>0&&this.setCurrentItem(t[0])}isMenuItem(t){var e;return t.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((e=t.getAttribute("role"))!=null?e:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>!(t.inert||!this.isMenuItem(t)))}getCurrentItem(){return this.getAllItems().find(t=>t.getAttribute("tabindex")==="0")}setCurrentItem(t){this.getAllItems().forEach(o=>{o.setAttribute("tabindex",o===t?"0":"-1")})}render(){return m`
      ...
      ></slot>
    `}};Pe.styles=gs;a([N("slot")],Pe.prototype,"defaultSlot",2);Pe.define("sl-menu");j.define("sl-menu-item");var Fs=C`
  ${L}
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.NVZL4YQ2.js.map
