...
`;var fi={name:"default",resolver:t=>uo(`assets/icons/${t}.svg`)},Us=fi;var fs={caret:`
  ...
  `},wi={name:"system",resolver:t=>t in fs?`data:image/svg+xml,${encodeURIComponent(fs[t])}`:""},ws=wi;var Re=[Us,ws],Ze=[];function Cs(t){Ze.push(t)}function Is(t){Ze=Ze.filter(e=>e!==t)}function wo(t){return Re.find(e=>e.name===t)}function Ee(t,e){ys(t),Re.push({name:t,resolver:e.resolver,mutator:e.mutator,spriteSheet:e.spriteSheet}),Ze.forEach(o=>{o.library===t&&o.setIcon()})}function ys(t){Re=Re.filter(e=>e.name!==t)}var vs=U`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.5NE3GOYN.js.map
