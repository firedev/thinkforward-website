...
`;var Z=class extends y{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){let t=!!this.href,e=t?Rt`a`:Rt`button`;return Et`
    ...
    `}};Z.styles=Ni;Z.dependencies={"sl-icon":G};a([N(".icon-button")],Z.prototype,"button",2);a([et()],Z.prototype,"hasFocus",2);a([n()],Z.prototype,"name",2);a([n()],Z.prototype,"library",2);a([n()],Z.prototype,"src",2);a([n()],Z.prototype,"href",2);a([n()],Z.prototype,"target",2);a([n()],Z.prototype,"download",2);a([n()],Z.prototype,"label",2);a([n({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);var Oi=new Map,_s=new WeakMap;function Ks(t){return t??{keyframes:[],options:{duration:0}}}function Ai(t,e){return e.toLowerCase()==="rtl"?{keyframes:t.rtlKeyframes||t.keyframes,options:t.options}:t}function q(t,e){Oi.set(t,Ks(e))}function P(t,e,o){let i=_s.get(t);if(i?.[e])return Ai(i[e],o.dir);let s=Oi.get(e);return s?Ai(s,o.dir):{keyframes:[],options:{duration:0}}}function mt(t,e){return new Promise(o=>{function i(s){s.target===t&&(t.removeEventListener(e,i),o())}t.addEventListener(e,i)})}function tt(t,e,o){return new Promise(i=>{if(o?.duration===1/0)throw new Error("Promise-based animations must be finite.");let s=t.animate(e,It(H({},o),{duration:$s()?0:o.duration}));s.addEventListener("cancel",i,{once:!0}),s.addEventListener("finish",i,{once:!0})})}function $s(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ot(t){return Promise.all(t.getAnimations().map(e=>new Promise(o=>{let i=requestAnimationFrame(o);e.addEventListener("cancel",()=>i,{once:!0}),e.addEventListener("finish",()=>i,{once:!0}),e.cancel()})))}var Wi=C`
  ${L}
...
lit-html/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=/_bridgetown/static/index.JSGJZNRO.js.map
